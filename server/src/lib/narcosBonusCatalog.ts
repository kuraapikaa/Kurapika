...
export const NARCOS_BONUSES: NarcosBonusDefinition[] = [
  ...
  },
  {
    ...
    rules: { lossBasisExcluded: true, firstDepositOnly: true, lossBonus: true, minimumDeposit: 250, maximumBonus: 2000, casinoWagering: 5, sportWagering: 3, minSportOdds: 1.5, minSportSelections: 2, maxCashoutMultiplier: 10 },
  ...
  },
  {
    ...
    rules: { lossBasisExcluded: true, firstDepositOnly: true, minimumDeposit: 250, bonusPercent: 100, casinoWagering: 2, sportWagering: 3, minSportOdds: 1.65, minSportSelections: 2, maxCashoutMultiplier: 8 },
  ...
  },
  {
    ...
    rules: { lossBasisExcluded: true, minimumDeposit: 500, maximumBonus: 5000, bonusPercent: 20, casinoWagering: 1, noOpenBets: true, unlimitedDaily: true },
  ...
  },
  {
    ...
    rules: { lossBasisExcluded: true, minimumDeposit: 500, maximumBonus: 5000, bonusPercent: 15, sportWagering: 1, minSportOdds: 1.3, sports: ['Futbol', 'Basketbol', 'Voleybol'], noOpenBets: true, unlimitedDaily: true },
  ...
  },
  {
    ...
    rules: { lossBasisExcluded: true, minimumDeposit: 500, bonusPercent: 10, maximumDepositForBenefit: 20000, spinValue: 2, game: 'Gates of Olympus Super Scatter', validityDays: 7, noWagering: true },
  ...
  },
  {
    ...
    rules: { lossBasisExcluded: true, dayOfWeek: 'Wednesday', tiers: [20, 40, 60, 80, 100], casinoWagering: 15, validityDays: 1, maxCashoutMultiplier: 10, liveCasino: true },
  ...
  },
  {
    ...
    rules: { lossBasisExcluded: true, minimumDeposit: 1000, minDepositAmount: 1000, checkLastTransactionIsDeposit: true, checkSingleInvestmentUsage: true, checkSameDayUsage: true, perDayLimit: 1, allowedProviders: ['Pragmatic Play'], allowedGameTypes: ['slot'], wageringMultiplier: 0, maxPayoutFixed: 7000, assignmentValues: { BonusMoneyAmount: 1 } },
  ...
  },
  {
    ...
    rules: { lossBasisExcluded: true, minimumDeposit: 1000, minDepositAmount: 1000, checkLastTransactionIsDeposit: true, checkSingleInvestmentUsage: true, checkSameDayUsage: true, perDayLimit: 1, allowedProviders: ['Pragmatic Play'], allowedGameTypes: ['slot'], wageringMultiplier: 0, maxPayoutFixed: 10000, assignmentValues: { BonusMoneyAmount: 1 } },
...
/**
 * Kayıp bonusu tabanından düşülecek bonusların adları.
 *
 * Bu bonuslar YATIRIM ÜZERİNE veriliyor: aynı paraya hem yatırım bonusu hem
 * kayıp bonusu verilmemesi için, bu bonusu alan yatırım kayıp tabanına girmez.
 */
export function lossBasisExcludedBonusNames(): string[] {
  const adlar: string[] = [];
  for (const bonus of NARCOS_BONUSES) {
    if ((bonus.rules as Record<string, unknown>)?.lossBasisExcluded !== true) continue;
    adlar.push(bonus.title);
    if (bonus.campaignTitle && bonus.campaignTitle !== bonus.title) adlar.push(bonus.campaignTitle);
  }
  return adlar;
}
