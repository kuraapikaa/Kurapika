            ...
            >
              <div className="login-brand-row mb-5 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div
                    className="flex h-11 w-11 items-center justify-center overflow-hidden rounded-xl border border-white/10 bg-white/[0.06]"
              ...
              <div className="login-security mt-4 flex items-center gap-2 text-[11px] text-slate-500">
