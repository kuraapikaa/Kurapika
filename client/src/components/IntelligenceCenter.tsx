        ...
        <div className="space-y-8 p-6 animate-in fade-in duration-700">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div>
                            ...
                            <div className="mt-2 flex items-center gap-3">
                                ...
                                <p className="text-[11px] font-black text-zinc-500 uppercase tracking-[0.2em]">Sistem İzleme Aktif</p>
                            </div>
                        </div>
                    </div>
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
                ...
                <div className="lg:col-span-12 grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <Card className="p-6 bg-zinc-900/50 border-white/5 flex items-center gap-5">
                        <div className="h-14 w-14 rounded-2xl bg-rose-500/10 flex items-center justify-center text-rose-400"><ShieldAlert size={24} /></div>
                        <div>
                            <p className="text-[10px] font-black text-zinc-500 uppercase tracking-widest">Kritik Riskli Oyuncular</p>
                            <p className="text-2xl font-black text-white">12</p>
                        </div>
                    </Card>
                    <Card className="p-6 bg-zinc-900/50 border-white/5 flex items-center gap-5">
                        <div className="h-14 w-14 rounded-2xl bg-amber-500/10 flex items-center justify-center text-amber-400"><Activity size={24} /></div>
                        <div>
                            <p className="text-[10px] font-black text-zinc-500 uppercase tracking-widest">Günlük Analiz Hacmi</p>
                            <p className="text-2xl font-black text-white">~1.2k</p>
                        </div>
                    </Card>
                    <Card className="p-6 bg-zinc-900/50 border-white/5 flex items-center gap-5">
                        <div className="h-14 w-14 rounded-2xl bg-emerald-500/10 flex items-center justify-center text-emerald-400"><Zap size={24} /></div>
                        <div>
                            <p className="text-[10px] font-black text-zinc-500 uppercase tracking-widest">Sistem Analiz Verimliliği</p>
                            ...
                            >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                        ...
                                        <Card key={cluster.id} className="relative overflow-hidden p-8 border-white/5 bg-zinc-900/80 backdrop-blur-md hover:border-purple-500/30 transition-all group">
                                            ...
                                            <div className="space-y-6">
                                                <div className="space-y-1">
                                                    <p className="text-[10px] font-black text-zinc-600 uppercase tracking-[0.2em]">{cluster.type} TEMELLİ ÇAKIŞMA</p>
                                                    ...
                                                    {cluster.clients.map((client: any) => (
                                                        <div key={client.id} className="flex items-center justify-between p-3 rounded-xl bg-white/5 border border-white/5 group/client hover:bg-white/10 transition-all">
                                                            <div className="flex flex-col">
                                                                <span className="text-xs font-black text-white">{client.login}</span>
                                    ...
                                    {(!clustersData?.clusters || clustersData.clusters.length === 0) && (
                                        <div className="col-span-full py-32 text-center rounded-[3rem] bg-zinc-900/30 border border-dashed border-white/10">
                                            <ShieldCheck className="mx-auto text-emerald-500/30 mb-6" size={64} />
                                            <p className="text-lg font-black text-zinc-500">Çakışan hesap kümesi bulunmadı.</p>
                                ...
                                <Card className="p-8 bg-zinc-900 border-white/10 shadow-2xl">
                                    <div className="flex flex-col md:flex-row items-end gap-6">
                                        ...
                                        <button
                                            ...
                                            className="h-16 px-12 bg-white text-zinc-950 rounded-2xl text-[12px] font-black shadow-2xl hover:bg-zinc-200 transition-all active:scale-95 flex items-center gap-3 uppercase tracking-widest"
                                        >
                                ...
                                <AnimatePresence mode="wait">
                                    {scorecardError ? (
                                        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="py-20 text-center">
                                            ...
                                            <p className="text-lg font-black text-white uppercase tracking-tight">ANALİZ HATASI</p>
                                            ...
                                            <Card className="lg:col-span-1 p-10 bg-zinc-950 border-white/5 relative overflow-hidden flex flex-col items-center text-center">
                                                ...
                                                <div className="relative mb-10">
                                                    ...
                                                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                                                        <span className="text-5xl font-black text-white">{scorecardData.scorecard.trustScore}</span>
                                                        <span className="text-[10px] font-black text-zinc-500 uppercase tracking-widest mt-1">GÜVEN PUANI</span>
                                                    </div>
                                                </div>

                                                <div className="space-y-2 mb-10">
                                                    <h3 className="text-2xl font-black text-white uppercase tracking-tight">{scorecardData.scorecard.login}</h3>
                                                    <p className="text-xs font-bold text-zinc-500">ID: {scorecardData.scorecard.clientId}</p>
                                                </div>

                                                <div className={cn(
                                                    "w-full py-4 rounded-2xl text-[11px] font-black tracking-[0.2em] uppercase shadow-lg",
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                    ...
                                                    <Card className="p-8 bg-zinc-900 border-white/5 space-y-6">
                                                        <div className="flex items-center gap-3">
                                                            ...
                                                            <h4 className="text-sm font-black text-white uppercase tracking-widest">Kritik Bulgular</h4>
                                                        </div>
                                                        <div className="space-y-3">
