            ...
            <AnimatePresence mode="wait">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {['[NAME]', '[URL]', '[DATE]'].map(tag => (
                                            <button
                                                ...
                                                className="px-3 py-1 bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg text-xs text-slate-400 transition-colors"
                                            >
                                                {tag}
                                            </button>
                                        ))}
                ...
                {activeTab === 'templates' && (
                    ...
                    >
                        ...
                        <Card className="border-dashed border-white/10 bg-transparent flex flex-center hover:bg-white/5 transition-all cursor-pointer min-h-[200px]">
                            <div className="m-auto text-center p-6">
                                <div className="w-12 h-12 bg-white/5 rounded-full flex items-center justify-center mx-auto mb-4 border border-white/10">
                                    <Trash2 className="w-5 h-5 text-slate-600" />
                                </div>
                                <h3 className="text-sm font-bold text-slate-500 uppercase tracking-widest">Özel Şablon Ekle</h3>
                                <p className="text-xs text-slate-600 mt-2">Yakında aktif olacak</p>
                            </div>
                        </Card>
                    </motion.div>
                )}
                                        ...
                                        {history.length === 0 ? (
                                            <tr>
                                                <td colSpan={5} className="p-12 text-center">
                                                    ...
                                                    <p className="text-slate-500 font-medium">Henüz bir gönderim geçmişi bulunmuyor.</p>
                                                </td>
                                            </tr>
                                        ) : (
                                            history.map((log) => (
