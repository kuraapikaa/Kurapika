// Kaynak: Magic UI (https://magicui.design/docs/components/confetti).
// `ConfettiButton` varyantı çıkarıldı — bu proje kendi Button bileşenini
// kullanıyor (case-insensitive dosya sisteminde shadcn'in "button.tsx"
// yazımı mevcut "Button.tsx" ile çakışırdı); yalnızca doğrudan tetiklenen
// `Confetti`/`ConfettiRef` bu projede kullanılıyor.
