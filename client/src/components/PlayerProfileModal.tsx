...
export function PlayerProfileModal({ clientId, username, onClose }: PlayerProfileModalProps) {
    ...
    const StatBox = ({ title, value, icon: Icon, colorClass, subValue }: any) => (
        <div className="glass-card rounded-xl border border-white/5 bg-[rgba(242,244,248,0.40)] p-4 transition-all hover:border-white/10 hover:bg-[rgba(242,244,248,0.60)]">
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-8 backdrop-blur-sm overflow-hidden">
            ...
            <div className="relative w-full max-w-5xl max-h-[90vh] flex flex-col overflow-hidden rounded-xl border border-white/10 bg-slate-900 shadow-2xl animate-in scale-in-95 duration-300">
                {/* Header - Fixed */}
                ...
                <div className="flex-1 overflow-y-auto p-6 pt-4 sm:p-8 sm:pt-6 space-y-8 text-left scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
                    {isLoading ? (
                        ...
                        <div className="space-y-8 animate-in slide-in-from-bottom-4 duration-500">
                            ...
                            <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                                <div>
                                    ...
                                    <div className="space-y-4">
                                        <div className="glass-card flex items-center justify-between rounded-xl bg-[rgba(242,244,248,0.40)] p-4 border border-white/5">
                                            ...
                                            <span className="text-sm font-semibold text-white">{formatNumber(kpi.TotalSportStakes)} <span className="text-[10px] text-slate-500">TRY</span></span>
                                        </div>
                                        <div className="glass-card flex items-center justify-between rounded-xl bg-[rgba(242,244,248,0.40)] p-4 border border-white/5">
                                            <div className="flex items-center gap-3">
                                            ...
                                            <span className="text-sm font-semibold text-emerald-400">{formatNumber(kpi.TotalSportWinnings)} <span className="text-[10px] text-slate-500">TRY</span></span>
                                        </div>
                                        <div className="glass-card flex items-center justify-between rounded-xl bg-[rgba(242,244,248,0.40)] p-4 border border-white/5">
                                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div className="space-y-4">
                                        <div className="glass-card flex items-center justify-between rounded-xl bg-[rgba(242,244,248,0.40)] p-4 border border-white/5">
                                            ...
                                            <span className="text-sm font-semibold text-white">{formatNumber(kpi.TotalCasinoStakes)} <span className="text-[10px] text-slate-500">TRY</span></span>
                                        </div>
                                        <div className="glass-card flex items-center justify-between rounded-xl bg-[rgba(242,244,248,0.40)] p-4 border border-white/5">
                                            <div className="flex items-center gap-3">
                                            ...
                                            <span className="text-sm font-semibold text-emerald-400">{formatNumber(kpi.TotalCasinoWinnings)} <span className="text-[10px] text-slate-500">TRY</span></span>
                                        </div>
                                        <div className="glass-card flex items-center justify-between rounded-xl bg-[rgba(242,244,248,0.40)] p-4 border border-white/5">
                                            <div className="flex items-center gap-3">
                            ...
                            {/* Account Details */}
                            <div className="rounded-xl border border-white/5 bg-[rgba(242,244,248,0.40)] p-6">
                                <h4 className="mb-6 text-[10px] font-semibold uppercase tracking-[0.2em] text-slate-500">Hesap ve Güvenlik Detayları</h4>
