...
export function PlayerProfileModal({ clientId, username, onClose }: PlayerProfileModalProps) {
    ...
    const StatBox = ({ title, value, icon: Icon, colorClass, subValue }: any) => (
        <div className="glass-card rounded-xl border border-white/5 bg-slate-900/40 p-4 transition-all hover:border-white/10 hover:bg-slate-900/60">
                            ...
                            <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                                <div>
                                    ...
                                    <div className="space-y-4">
                                        <div className="glass-card flex items-center justify-between rounded-xl bg-slate-950/40 p-4 border border-white/5">
