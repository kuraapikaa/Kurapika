                ...
                <div className="flex shrink-0 items-center justify-between p-6 pb-4 sm:p-8 sm:pb-6 border-b border-white/5">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-xs font-bold text-slate-400 uppercase tracking-wider text-left">Müşteri ID: #{clientId}</p>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <div className="flex-1 overflow-y-auto p-6 pt-4 sm:p-8 sm:pt-6 space-y-8 text-left scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
                    {isLoading ? (
                        <div className="flex flex-col items-center justify-center py-20 gap-4">
                            ...
                            <p className="text-sm font-bold text-slate-400 uppercase tracking-wider animate-pulse">Profil verileri analiz ediliyor...</p>
                        </div>
                    ) : error || !kpi ? (
                            ...
                            <div className="rounded-xl border border-white/5 bg-white/[0.02] p-6">
                                ...
                                <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <p className="text-[9px] font-bold text-slate-400 uppercase">Doğrulama</p>
                                            <p className="text-sm font-bold text-white">{kpi.IsVerified ? 'Onaylı Hesap' : 'Onaysız'}</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-4">
                                        <div className="rounded-xl bg-white/5 p-3 text-slate-400"><Calendar size={24} /></div>
                                        <div>
                                            <p className="text-[9px] font-bold text-slate-400 uppercase">İlk Yatırım</p>
                                            <p className="text-sm font-bold text-white">{kpi.FirstDepositTimeLocal ? formatDateDisplay(kpi.FirstDepositTimeLocal) : '-'}</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-4">
                                        <div className="rounded-xl bg-white/5 p-3 text-slate-400"><Activity size={24} /></div>
                                        <div>
                                            <p className="text-[9px] font-bold text-slate-400 uppercase">Son İşlem</p>
