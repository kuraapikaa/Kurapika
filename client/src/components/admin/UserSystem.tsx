            ...
            <div className="grid gap-2 sm:grid-cols-2">
              {PERMISSIONS.map((permission) => {
                ...
                return (
                  ...
                  >
                    <span className={cn('mt-0.5 grid h-5 w-5 place-items-center rounded-lg border', selected ? 'border-cyan-300 bg-cyan-300 text-slate-950' : 'border-slate-700 text-transparent')}>
                      <Check size={13} />
                    </span>
                    <span>
