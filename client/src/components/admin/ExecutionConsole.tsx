    ...
    <div className="group relative flex flex-col rounded-xl border border-white/5 bg-slate-950/40 shadow-2xl backdrop-blur-3xl overflow-hidden h-[300px] transition-all duration-500 hover:border-cyan-500/20">
      ...
      <div className="flex items-center justify-between border-b border-white/5 bg-white/[0.02] px-3 py-2.5">
        ...
        <div className="flex gap-2">
          <div className="flex items-center gap-1.5 px-2 py-1 rounded-md bg-white/[0.03] border border-white/5">
            ...
            <span className="text-[8px] font-bold text-slate-500">v1.4.0-STABLE</span>
          </div>
        </div>
      </div>
        ...
        <div className="relative z-10 space-y-4">
          ...
          <div className="flex items-center gap-4 pt-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[9px] font-bold text-slate-600 uppercase tracking-tighter">Gateway: Online</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="h-1 w-1 rounded-full bg-emerald-500" />
              <span className="text-[9px] font-bold text-slate-600 uppercase tracking-tighter">Database: Connected</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="h-1 w-1 rounded-full bg-cyan-500" />
              <span className="text-[9px] font-bold text-slate-600 uppercase tracking-tighter">Worker: Idle</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-white/5 bg-slate-900/40 px-6 py-2 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-[9px] font-mono text-slate-600 tabular-nums">MEM: 124MB</span>
        </div>
      </div>
    </div>
  );
