...
export function LoyaltySettings() {
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            {/* Ratio Config */}
            <div className="p-8 bg-[rgba(242,244,248,0.40)] border border-[color:var(--panel-border,rgba(242,244,248,0.1))] rounded-xl">
                ...
                <div className="flex items-center gap-4 max-w-sm">
                   ...
                   <div className="flex-1 space-y-2">
                        ...
                        <div className="w-full bg-[rgba(242,244,248,0.50)] border border-[color:var(--panel-border,rgba(242,244,248,0.1))] rounded-xl px-3 py-2.5 text-xl font-semibold text-amber-500 flex items-center gap-3">
                            <Coins size={24} /> 1
                        </div>
                   </div>
                </div>
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {market.map((item, idx) => (
                        <div key={item.id} className="p-6 bg-[rgba(242,244,248,0.40)] border border-[color:var(--panel-border,rgba(242,244,248,0.1))] rounded-xl space-y-4 group hover:border-amber-500/20 transition-all">
                             <div className="flex items-center justify-between">
