    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="p-8 bg-zinc-950/40 border border-white/5 rounded-xl">
                ...
                <p className="mt-4 text-[10px] text-zinc-600 font-bold uppercase tracking-widest">
                    ...
                    {market.map((item, idx) => (
                        <div key={item.id} className="p-6 bg-zinc-950/40 border border-white/5 rounded-xl space-y-4 group hover:border-amber-500/20 transition-all">
                             ...
                             <textarea 
                                ...
                                className="w-full bg-black/30 border border-white/5 rounded-xl p-3 text-xs font-bold text-zinc-400 outline-none focus:border-amber-500/20 min-h-[60px]"
                            />
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                ...
                                <div className="space-y-1 col-span-3">
                                    ...
                                    >
                                        ...
                                        <option value="bonus" className="bg-zinc-900 text-white">Özel Bonus</option>
                                    </select>
                                </div>
                            </div>
                        </div>
