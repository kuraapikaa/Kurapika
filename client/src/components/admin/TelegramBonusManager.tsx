...
export function TelegramBonusManager({ config, bonusOptions, onUpdate }: TelegramBonusManagerProps) {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 gap-5 rounded-lg border border-[color:var(--panel-border,rgba(242,244,248,0.1))] bg-[color:var(--panel-surface,rgba(242,244,248,0.028))] p-5 md:grid-cols-2">
      ...
      <div className="flex items-start gap-3 rounded-lg border border-sky-500/15 bg-sky-500/[0.04] p-4 text-xs font-medium text-sky-200/80">
