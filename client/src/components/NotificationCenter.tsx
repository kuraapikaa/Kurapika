            ...
            <AnimatePresence>
                {isOpen && (
                    ...
                    >
                            ...
                            <div className="flex items-center gap-2">
                                {unread > 0 && (
                                    <button
                                        ...
                                        className="rounded-lg p-1.5 text-slate-400 transition-colors hover:bg-white/10 hover:text-white" title="Tümünü okundu işaretle"
                                    >
                                        <Check size={16} />
                                    </button>
                                )}
                                {notifications.length > 0 && (
                                    <button
                                        onClick={clearAll}
                                        className="rounded-lg p-1.5 text-slate-400 transition-colors hover:bg-rose-500/20 hover:text-rose-400" title="Tümünü temizle"
                                    >
                                        <Trash2 size={16} />
                                    </button>
                                )}
                                    ...
                                    {notifications.map((notif) => (
                                        ...
                                        >
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <div className="mt-1.5 font-mono text-xs font-bold text-slate-300">
                                                    {notif.type === 'deposit' ? (
                        ...
                        <div className="border-t border-white/5 bg-[#0a0e15] p-2 text-center">
                            <p className="text-[10px] text-slate-400 uppercase tracking-wider font-semibold flex items-center justify-center gap-1.5"><span className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse"></span> Sistem Takip Ediliyor</p>
                        </div>
                    </motion.div>
                )}
            </AnimatePresence>
