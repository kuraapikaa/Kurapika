...
export function NarcosKpiPanel({ dateRange, enabled }: { dateRange: DateRange; enabled: boolean }) {
  ...
  return (
    <section className="rounded-xl border border-[#3b82f6]/20 bg-[#110d07]/80 p-4 shadow-[0_14px_45px_rgba(0,0,0,.2)]">
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-2 text-[#5eead4]"><Database size={16} /><span className="text-[10px] font-semibold uppercase tracking-[0.16em]">Lynon canlı rapor KPI</span></div>
