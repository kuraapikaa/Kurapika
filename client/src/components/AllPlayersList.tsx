    ...
    <section className="flex flex-col gap-10 h-full">
      <header className="flex flex-col gap-8">
        <div className="flex flex-wrap items-center justify-between gap-6 px-1">
          ...
          <div className="flex items-center gap-3">
            <button className="flex items-center gap-2 rounded-xl bg-blue-500 px-5 py-2.5 text-[10px] font-semibold text-white shadow-xl shadow-blue-500/20 hover:bg-[color:var(--panel-accent,#0a84ff)] transition-all uppercase tracking-widest">
      ...
      {isLoading ? (
        <div className="flex h-96 flex-col items-center justify-center gap-4 rounded-xl border border-[color:var(--panel-border,rgba(242,244,248,0.1))] bg-[color:var(--panel-surface,rgba(242,244,248,0.028))]">
