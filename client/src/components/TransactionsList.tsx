...
export function TransactionsList({ dateRange }: TransactionsListProps) {
    ...
    return (
        <section className="animate-in space-y-6 pb-10">
            ...
            {/* Filter Section */}
            <div className="rounded-xl border border-[color:var(--panel-border,rgba(242,244,248,0.1))] bg-[color:var(--panel-surface,rgba(242,244,248,0.028))] backdrop-blur-md overflow-hidden transition-all">
                <button
            ...
            {/* Table Section */}
            <div className="rounded-xl border border-[color:var(--panel-border,rgba(242,244,248,0.1))] bg-[color:var(--panel-surface,rgba(242,244,248,0.028))] p-4 backdrop-blur-md overflow-hidden">
                {isLoading ? (
                    ...
                    <div className="overflow-x-auto overflow-y-auto max-h-[700px] scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
                        <table className="w-full text-left">
                            <thead>
                                <tr className="border-b border-[color:var(--panel-border,rgba(242,244,248,0.1))] sticky top-0 bg-[color:var(--panel-surface,rgba(242,244,248,0.028))] backdrop-blur-md z-10">
                                ...
                                {transactions.map((tx: any) => (
                                    <tr key={tx.Id} className="group hover:bg-white/[0.02] transition-colors">
                                        <td className="py-6 pl-6">
                                            <div className="flex items-center gap-4">
                                                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[color:var(--panel-surface,rgba(242,244,248,0.028))] text-[color:var(--panel-muted,#8a919c)] group-hover:bg-blue-500 group-hover:text-white transition-all ring-1 ring-white/5 shadow-inner">
                                                    <User size={18} />
                                                </div>
                                                <div className="text-left">
        ...
        <div className="space-y-1.5">
            ...
            <div className="relative">
                ...
                <input
                    ...
                    disabled={disabled}
                    className={`h-10 w-full rounded-xl border border-[color:var(--panel-border,rgba(242,244,248,0.1))] bg-[color:var(--panel-surface,rgba(242,244,248,0.028))] ${Icon ? 'pl-9' : 'px-3'} py-2 text-xs font-medium text-white transition-all focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/20 outline-none disabled:opacity-50`}
                />
            </div>
        </div>
    );
    ...
    return (
        <div className="space-y-1.5">
            ...
            <select
                value={value}
                onChange={(e) => onChange?.(e.target.value)}
                className="h-10 w-full rounded-xl border border-[color:var(--panel-border,rgba(242,244,248,0.1))] bg-[color:var(--panel-surface,rgba(242,244,248,0.028))] px-3 py-2 text-xs font-medium text-white transition-all focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/20 outline-none appearance-none"
            >
                {options.map((opt: any) => (
