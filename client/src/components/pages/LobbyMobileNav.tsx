...
export function LobbyMobileNav({ active }: { active?: PublicPage }) {
  return (
    <nav className="sticky top-0 z-40 w-full border-b border-[#d4af37]/20 bg-[#100b04]/95 px-2 py-2.5 shadow-[0_12px_35px_rgba(0,0,0,.28)] backdrop-blur-2xl sm:px-4 md:px-8">
      <div className="mx-auto w-full max-w-7xl">
        <div className="grid grid-cols-4 gap-1 rounded-[1.1rem] border border-[#d4af37]/20 bg-[#080502]/70 p-1 sm:grid-cols-8">
          {navItems.map((item) => {
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ? 'bg-[#d4af37] text-[#100b04] shadow-[0_10px_26px_rgba(212,175,55,.24)]'
                    : 'text-zinc-400 hover:bg-[#d4af37]/10 hover:text-[#f4d36f]'
                )}
              >
