    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500 flex flex-col min-h-0 h-full">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3 lg:grid-cols-3 shrink-0">
                <div className="rounded-xl border border-[color:var(--panel-border,rgba(242,244,248,0.1))] bg-[color:var(--panel-surface,rgba(242,244,248,0.028))] p-5 backdrop-blur-sm relative overflow-hidden group">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="rounded-xl border border-[color:var(--panel-border,rgba(242,244,248,0.1))] bg-[color:var(--panel-surface,rgba(242,244,248,0.028))] p-5 shadow-lg">
            ...
            {/* Table Section */}
            <div className="rounded-xl border border-[color:var(--panel-border,rgba(242,244,248,0.1))] bg-[color:var(--panel-surface,rgba(242,244,248,0.028))] shadow-xl overflow-hidden flex flex-col flex-1 min-h-0">
                <div className="border-b border-[color:var(--panel-border,rgba(242,244,248,0.1))] bg-white/5 px-3 py-2.5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 shrink-0">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="h-10 w-full sm:w-64 rounded-xl border border-[color:var(--panel-border,rgba(242,244,248,0.1))] bg-[color:var(--panel-surface,rgba(242,244,248,0.028))] pl-10 pr-4 text-sm text-white placeholder:text-[color:var(--panel-muted,#8a919c)] focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
                        />
                    </div>
                </div>
                ...
                <div className="overflow-auto flex-1 h-[600px]">
                    <table className="w-full text-sm text-left relative">
                        <thead className="sticky top-0 z-10 bg-[color:var(--panel-surface,rgba(242,244,248,0.028))] backdrop-blur-sm">
                                        ...
                                        <tr key={idx} className="group hover:bg-white/[0.02] transition-colors">
                                            ...
                                            <td className="px-3 py-2.5 text-center">
                                                <div className="flex flex-col items-center">
                                                    ...
                                                    {item.ResultType === 3 && <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-[rgba(242,244,248,0.08)] text-[color:var(--panel-muted,#8a919c)]">İptal Edildi</span>}
                ...
                {/* Pagination Controls */}
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-[color:var(--panel-border,rgba(242,244,248,0.1))] bg-[color:var(--panel-surface,rgba(242,244,248,0.028))] px-3 py-2.5">
                    <div className="flex items-center gap-2 text-sm text-[color:var(--panel-muted,#8a919c)]">
                        ...
                        <select
                            ...
                            className="rounded-lg border border-[color:var(--panel-border,rgba(242,244,248,0.1))] bg-[color:var(--panel-surface,rgba(242,244,248,0.028))] px-2 py-1 text-white focus:border-blue-500 focus:outline-none"
                        >
