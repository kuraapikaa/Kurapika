          ...
          {eksikDavranis.length > 0 && (
            <div className="flex flex-wrap items-center justify-between gap-3 border-t border-white/[0.06] px-4 py-3">
              ...
              <button
                ...
                className="h-9 shrink-0 rounded-xl bg-[color:var(--panel-accent,#0a84ff)] px-3 text-xs font-semibold text-white hover:brightness-110 disabled:opacity-40"
              >
                ...
                <PanoSatir key={oneri.playerId}>
                  <PanoHucreYazi>
                    <span className="flex flex-col">
                      ...
                      <span className="text-[10px] text-slate-400">{oneri.playerId}</span>
                    </span>
                  </PanoHucreYazi>
                    ...
                    {durum === 'ok' ? (
                      ...
                      <span className="flex flex-col items-end gap-1">
                        <button
                          ...
                          className="rounded-md border border-white/5 px-2.5 py-1 text-[11px] font-semibold text-slate-200 hover:bg-white/[0.06] disabled:opacity-40"
                        >
                          Uygula
                        </button>
                        {durum && durum !== 'ok' && (
