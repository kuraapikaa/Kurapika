  ...
  return (
    <div className="animate-in space-y-6">
        ...
        <div className="space-y-6">
          <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-6 flex items-center justify-between gap-4 flex-wrap">
            ...
            <div className="flex gap-6">
              <div>
                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest text-right">Net Yatırım</p>
              ...
              {depositWithdrawRatio != null && (
                <div>
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest text-right">Ç/Y Oranı</p>
                  <p className="text-lg font-mono font-bold text-slate-200 text-right">%{(depositWithdrawRatio).toFixed(1)}</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-1 bg-gradient-to-br from-blue-500/10 to-transparent">
            ...
            <div className="p-6">
              ...
              <div className="flex items-center gap-6 mt-4">
                ...
                <div>
                  <p className="text-[10px] font-bold text-slate-400 uppercase mb-1">Etiket:</p>
                ...
                <div className="rounded-xl bg-white/10 p-4 border border-white/5">
                  ...
                  <ul className="space-y-2 text-sm">
                    {execReport.mathEvidences.map((item, idx) => (
                      <li key={idx} className="flex gap-2 text-slate-200 items-start">
      ...
      {!report && !loading && submitSearch && !error && (
        <p className="text-center text-slate-400">Sonuç bulunamadı veya veri yüklenemedi.</p>
      )}
    </div>
  );
}
