...
export function AdminGames({ initialTab }: AdminGamesProps = {}) {
  ...
  // NOT: burada "/admin/oyun-ayarlari" altindaki artik yollari temizleyen
  // bir window.history.replaceState cagrisi vardi. HashRouter altinda
  // yanlisti — hash'i degil GERCEK yolu degistiriyordu. Isi artik rota
  // agaci yapiyor: /admin/oyun-ayarlari/* buraya yonlendiriliyor.
      ...
      <div className="rounded-3xl border border-white/[0.05] bg-white/[0.02] p-8 shadow-[0_18px_60px_rgba(0,0,0,0.24)] backdrop-blur-xl">
        <div className="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
                ...
                return (
                  ...
                  >
                    ...
                    <span className="min-w-0">
                      ...
                      <span className="mt-0.5 block truncate text-[11px] font-semibold text-slate-400">{tab.description}</span>
                    </span>
                  </button>
                );
              })}
          ...
          <button
            ...
            className="inline-flex h-11 shrink-0 items-center justify-center gap-2 rounded-xl bg-[color:var(--panel-accent,#0a84ff)] px-5 text-xs font-semibold uppercase tracking-widest text-[#050609] transition hover:bg-[color:var(--panel-info,#64d2ff)] disabled:cursor-not-allowed disabled:opacity-60"
          >
