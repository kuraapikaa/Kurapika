        ...
        return (
            <div className="flex h-[400px] items-center justify-center">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <p className="text-sm font-bold uppercase tracking-widest text-slate-400">Rapor Hazırlanıyor...</p>
                </div>
            </div>
        );
    }
        ...
        <div className="space-y-6 animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
                <StatCard
                    ...
                    value={totalTurnover}
                    icon={<BarChart3 className="text-purple-300" />}
                    trend="neutral"
                />
                <StatCard
                ...
                <div className="rounded-2xl border border-blue-500/30 bg-blue-950/40 p-5 shadow-lg relative overflow-hidden group">
                    ...
                    <div className="mt-3 flex items-center gap-2">
                        <span className="text-[10px] font-bold text-slate-400 uppercase">Royalty:</span>
                        <select
                            className="bg-white/10 text-[10px] font-semibold text-purple-300 border border-white/5 rounded px-1 py-0.5 focus:ring-0 cursor-pointer"
                            value={royaltyRate}
                ...
                <StatCard
                    ...
                    icon={<Info className="text-purple-300" />}
                    trend="neutral"
                />
            </div>
                                    ...
                                    <tr key={idx} className="group hover:bg-white/[0.02] transition-colors">
                                        <td className="px-3 py-2.5">
                                            <div className="flex flex-col">
                                                ...
                                                <span className="text-[10px] text-slate-400 font-mono">{item.ProviderPrefix}</span>
                                            </div>
                                        </td>
    ...
    return (
        <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-5 shadow-lg group hover:border-white/5 transition-all">
            <div className="flex items-center justify-between mb-3">
                ...
                {trend !== 'neutral' && (
                    <div className={`p-1 rounded-xl ${trend === 'up' ? 'text-emerald-400 bg-emerald-500/10' : 'text-rose-400 bg-rose-500/10'}`}>
