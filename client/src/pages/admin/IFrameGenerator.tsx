...
const PAGES = [
  { id: 'lobi',          label: 'Oyun Lobisi',    path: '/lobi',              icon: Layout,   color: 'text-purple-300', badge: 'Popüler' },
  ...
  { id: 'turnuva',       label: 'Günlük Turnuva', path: '/turnuva/gunluk',    icon: Trophy,   color: 'text-purple-300' },
  ...
  return (
    <div className="flex flex-col items-center gap-10 py-8">
      ...
      <button
        ...
        className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/5 text-slate-400 hover:text-white text-xs font-bold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30"
      >
    ...
    <div className="w-full overflow-hidden" style={{
      ...
      <div style={{ background: '#141422', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
        ...
        <div className="flex items-end px-3 pt-2.5 gap-0" style={{ borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
          {/* Active tab */}
          <div className="flex items-center gap-2 px-3.5 py-2 text-xs text-slate-200 font-medium max-w-[200px] min-w-0 relative"
            ...
            <span className="ml-1 text-slate-500 hover:text-white cursor-pointer flex-shrink-0">×</span>
          </div>
          <div className="mb-0.5 ml-1 flex h-6 w-6 items-center justify-center rounded-full text-sm text-slate-500 hover:text-slate-400 cursor-pointer">+</div>
        </div>
        ...
        <div className="flex items-center gap-2.5 px-4 py-2.5">
          ...
          {/* Address bar */}
          <div className="flex flex-1 items-center gap-2 px-3 py-1.5 rounded-xl min-w-0"
            ...
            <button type="button" aria-label="Yenile" onClick={() => setKey(k => k + 1)} className="flex-shrink-0 text-slate-500 hover:text-white transition-colors">
              <RefreshCw size={11} aria-hidden="true" />
            </button>
          </div>
          {/* Open in new tab */}
          <a href={url} target="_blank" rel="noreferrer"
            className="flex-shrink-0 p-1.5 rounded-xl text-slate-500 hover:text-white transition-colors hover:bg-white/5">
        ...
        <div className="lg:col-span-4 space-y-4">
          <div className="rounded-xl overflow-hidden" style={{ border: '1px solid rgba(255,255,255,0.05)', background: 'rgba(18,18,30,0.7)' }}>
            <div className="flex items-center gap-2.5 px-5 py-4" style={{ borderBottom: '1px solid rgba(255,255,255,0.05)', background: 'rgba(0,0,0,0.2)' }}>
              <Settings2 size={17} className="text-purple-300" />
                  ...
                  {PAGES.map(page => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {active && (
                          <Check size={13} className="text-purple-300 flex-shrink-0" aria-hidden="true" />
                        )}
                      </button>
                    );
                  })}
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full text-sm font-mono text-white rounded-xl px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-400/40 transition-colors"
                      style={{ background: 'rgba(0,0,0,0.4)', border: '1px solid rgba(255,255,255,0.08)' }}
                    />
                  </div>
                  <div>
                    <label htmlFor="iframe-height" className="text-[10px] text-slate-500 mb-1 block">Yükseklik (px)</label>
                    <input
                      id="iframe-height"
                      type="number"
                      value={config.height}
              ...
              <div>
                ...
                <div className="space-y-2.5">
                  ...
                  <div className="flex items-center justify-between gap-3 px-3.5 py-2.5 rounded-xl"
                    ...
                    <label htmlFor="iframe-radius" className="text-[13px] font-medium text-slate-200 shrink-0">Köşe yumuşatma</label>
                    <div className="flex items-center gap-2">
                      ...
                      />
                      <span className="text-xs font-bold text-slate-400 w-9 text-right" aria-hidden="true">{config.borderRadius}px</span>
                    </div>
                  </div>
                  ...
                  {[
                    ...
                    <div key={item.key} className="flex items-center justify-between px-3.5 py-2.5 rounded-xl"
                      style={{ background: 'rgba(0,0,0,0.2)', border: '1px solid rgba(255,255,255,0.05)' }}>
                      <span className="text-[13px] font-medium text-slate-200">{item.label}</span>
        ...
        <div className="lg:col-span-8 space-y-5">
          ...
          <div className="rounded-xl overflow-hidden" style={{ border: '1px solid rgba(255,255,255,0.05)', background: 'rgba(18,18,30,0.7)' }}>
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 px-4 sm:px-5 py-3.5" style={{ borderBottom: '1px solid rgba(255,255,255,0.05)', background: 'rgba(0,0,0,0.2)' }}>
              ...
              <div role="group" aria-label="Görünüm modu" className="flex items-center gap-1 rounded-xl p-1" style={{ background: 'rgba(0,0,0,0.4)', border: '1px solid rgba(255,255,255,0.06)' }}>
                <button
                  ...
                  className={cn('flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-xl text-xs font-bold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-400/50', device === 'desktop' ? 'text-white' : 'text-slate-500 hover:text-slate-400')}
                ...
                <button
                  ...
                  className={cn('flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-xl text-xs font-bold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-400/50', device === 'mobile' ? 'text-white' : 'text-slate-500 hover:text-slate-400')}
            ...
            <div className="flex items-center gap-2 px-4 sm:px-5 py-3" style={{ borderTop: '1px solid rgba(255,255,255,0.05)', background: 'rgba(0,0,0,0.3)' }}>
              ...
              <span className="flex-1 text-[11px] font-mono truncate text-slate-400 min-w-0">{embedUrl}</span>
              <button
                type="button"
                aria-label={copied === 'url' ? 'URL kopyalandı' : 'URL kopyala'}
                onClick={() => handleCopy('url')}
                className="flex-shrink-0 flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl text-[11px] font-bold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400/50"
              ...
              <a href={embedUrl} target="_blank" rel="noreferrer"
                ...
                className="flex-shrink-0 flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl text-[11px] font-bold text-slate-400 hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30"
            ...
            <div className="p-5">
              ...
              <div className="relative rounded-xl overflow-hidden" style={{ background: '#070a10', border: '1px solid rgba(255,255,255,0.05)' }}>
                ...
                <div className="absolute left-0 top-0 bottom-0 w-10 flex flex-col items-end pr-2 pt-4 gap-[1px] pointer-events-none select-none"
                  ...
                  {generatedCode.split('\n').map((_, i) => (
                    <span key={i} className="text-[11px] font-mono leading-5 text-slate-500">{i + 1}</span>
                  ))}
                </div>
                <textarea
                  readOnly
              ...
              <div className="mt-4 flex gap-3 items-start px-4 py-3 rounded-xl"
                ...
                <p className="text-[12px] leading-relaxed font-medium" style={{ color: 'rgba(253,230,138,0.6)' }}>
                  <span className="text-amber-400 font-semibold uppercase text-[10px] tracking-widest block mb-1">Önemli</span>
