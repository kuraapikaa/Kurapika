            ...
            {mukerrer.slice(0, 20).map((satir) => (
              <PanoSatir key={`${satir.clientId}-${satir.bonusAdi}`}>
                <PanoHucreYazi>
                  ...
                  <span className="ml-2 text-[11px] text-slate-400">{satir.clientId}</span>
                </PanoHucreYazi>
              ...
              <PanoSatir key={satir.Id}>
                <PanoHucreYazi>
                  <span className="flex flex-col">
                    ...
                    <span className="text-[10px] text-slate-400">{satir.ClientId}</span>
                  </span>
                </PanoHucreYazi>
                <PanoHucreYazi>
                  <span className="flex flex-col">
                    ...
                    <span
                      className="max-w-[420px] truncate text-[10px] text-slate-400"
                ...
                <PanoHucreYazi>
                  <span className="rounded-md border border-white/[0.08] bg-white/[0.04] px-2 py-0.5 text-[10px] font-semibold uppercase tracking-[0.08em] text-slate-200">
                    {satir.Durum}
                  </span>
                  {satir.Kategori && (
                    <span className="ml-1.5 text-[10px] text-slate-400">{satir.Kategori}</span>
                  )}
                </PanoHucreYazi>
                <PanoHucreYazi>
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 border-t border-white/[0.06] px-4 py-3">
            <div className="flex items-center gap-2 text-[11px] text-slate-400">
              <select
                ...
                className="rounded-md border border-white/5 bg-[#0c1119] px-2 py-1 text-white focus:outline-none"
              >
            ...
            <div className="flex items-center gap-2 text-[11px]">
              <button
                ...
                disabled={sayfa === 1}
                className="rounded-md px-2.5 py-1 text-slate-400 hover:bg-white/[0.05] hover:text-white disabled:cursor-not-allowed disabled:opacity-40"
              >
                Önceki
              </button>
