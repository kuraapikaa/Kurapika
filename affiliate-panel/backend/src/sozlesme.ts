...
import type { AltLinkOyuncusu, EslesmeCakismasi, OyuncuEslesmesi, VarsayilanGocSonucu } from './servisler/oyuncuEslesme.js';
...
export interface YonetimUclari {
  ...
  '/oyuncu-eslesmeleri/varsayilan-dagit': VarsayilanGocSonucu;
}
